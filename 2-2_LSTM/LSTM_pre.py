# Encoding: UTF-8
# Author: Kylin Zhang
# Time: 2024/5/29 - 23:03

# step2-2-2：用训练好的LSTM网络进行预测
...
folder_name = 'result_2024-06-08_13-25-14'  # 选择要导入的LSTM网络模型对应的文件夹名称
model_name = 'LSTM_Net.pth'
lstm_net = torch.load(os.path.join(save_path, folder_name, model_name))
lstm_net.to(device)
